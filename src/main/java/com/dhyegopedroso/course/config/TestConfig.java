...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o4 = new Order(null, Instant.parse("2019-08-20T19:53:07Z"), u3);
		Order o5 = new Order(null, Instant.parse("2019-08-21T03:42:10Z"), u4);
		Order o6 = new Order(null, Instant.parse("2019-09-22T15:21:22Z"), u4);
		Order o7 = new Order(null, Instant.parse("2019-09-20T19:53:07Z"), u1);
		Order o8 = new Order(null, Instant.parse("2019-09-21T03:42:10Z"), u2);
		Order o9 = new Order(null, Instant.parse("2019-10-22T15:21:22Z"), u4);
